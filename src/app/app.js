window.onload = function () {
	...
	var obras_info_amarilla_Icon = L.icon({
		iconUrl: 'assets/obras_info_amarilla.png',
		iconSize:     [18, 22],
		});
 ...
 */
 	
 	//			Federalismo - Av Alcalde
 	
 	L.marker([20.71774470388065, -103.35272312164308],{icon: obras_info_amarilla_Icon}).bindPopup('<p style="text-align:center; font-size: 14px;">CANAL ATEMAJAC TRAMO DE CALZ. FEDERALISMO A AV. ALCALDE</p><a href="assets/obras_info/canal_atemajac.pdf" target="_blank">Ver detalles</a>').addTo(obras).openPopup();
	L.marker([20.723524782775204, -103.34499835968018],{icon: obras_info_amarilla_Icon}).bindPopup('<p style="text-align:center; font-size: 14px;">CANAL ATEMAJAC TRAMO DE AV. ALCALDE A PERIFÉRICO NORTE</p><a href="assets/obras_info/canal_atemajac_alcalde-peri.pdf" target="_blank">Ver detalles</a>').addTo(obras).openPopup();
	...
	
 	//			Colector Felipe Zetter
 	
	L.marker([20.638165953105457, -103.43052864074707],{icon: obras_info_amarilla_Icon}).bindPopup('<p style="text-align:center; font-size: 14px;">COLECTOR FELIPE ZETTER</p><a href="assets/obras_info/colector_zeter.pdf" target="_blank">Ver detalles</a>').addTo(obras).openPopup();
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 	...
 	
	L.marker([20.65218158361873, -103.43297481536865],{icon: obras_info_amarilla_Icon}).bindPopup('<p style="text-align:center; font-size: 14px;">COLECTOR COPÉRNICO</p><a href="assets/obras_info/colector_copernico.pdf" target="_blank">Ver detalles</a>').addTo(obras).openPopup();
	...
	
 	//			AMPLIACIÓN VASO EL DEÁN
 	
	L.marker([20.638326598021653, -103.3468008041382],{icon: obras_info_amarilla_Icon}).bindPopup('<p style="text-align:center; font-size: 14px;">AMPLIACIÓN VASO EL DEÁN</p><a href="assets/obras_info/ampliación_baso_dean_4.pdf" target="_blank">Ver detalles</a>').addTo(obras).openPopup();
	...
	
 	//			COLECTOR AV. AVIACIÓN
 	
	L.marker([20.76173197411026, -103.43930482864381],{icon: obras_info_amarilla_Icon}).bindPopup('<p style="text-align:center; font-size: 14px;">COLECTOR AV. AVIACIÓN</p><a href="assets/obras_info/colector_aviación.pdf" target="_blank">Ver detalles</a>').addTo(obras).openPopup();
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 	...
 	
	L.marker([20.652984732475133, -103.29650402069092],{icon: obras_info_amarilla_Icon}).bindPopup('<p style="text-align:center; font-size: 14px;">DEPÓSITO SAN ANDRÉS</p><a href="assets/obras_info/dep_sanandres.pdf" target="_blank">Ver detalles</a>').addTo(obras).openPopup();
...
//Figure
	...
	**/
	...
	/**
	 * 6.- AMPLIACIÃ“N DEL VASO REGULADOR EL DEÁN PROGRAMA DE OBRA: DE SEMANA 2 A SEMANA 32
	**/
	var obra6 = L.polygon([
 ...
 */
	...
	var area3_roja = [
		[20.641810542904523, -103.43549072742464],
		[20.641664961790873, -103.43483090400697],
		[20.64132610865911, -103.4348711371422],
		[20.640851713006413, -103.43484967947008],
		[20.640367275707174, -103.43473970890047],
		[20.639817575556002, -103.43450635671617],
		[20.63933062490434, -103.43419253826141],
		[20.63887379349436, -103.4337902069092],
		[20.638502303204497, -103.43326449394226],
		[20.637207100233898, -103.43345761299135],
		[20.636659898766165, -103.43355417251588],
		[20.635967108763566, -103.43366146087646],
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////  linea de Av Patria hacia Fidel Velazquez Sanchez  ///////////////////////
	var area1_alterna_roja = [
		//inicia en Av- Patria
		//inicia linea y sentido de la flecha animatePolypoint
		...
		//termina linea y sentido de la flecha animatePolypoint
	];
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
/////  linea de Av Fray Antonio Alcalde -> Av Cvln Divicion del Nte y Calz del Federalismo Norte  //////
	var area1_alterna_roja2 = [
		//inicia en Av Fray Antonio Alcalde
		//inicia linea y sentido de la flecha animatePolypoint
		...
		//termina linea y sentido de la flecha animatePolypoint
		//termina en Calz del Federalismo Norte
		];
...
/////  linea de Av Fray Antonio Alcalde -> Av Cvln Divicion del Nte y Calz del Federalismo Norte  //////
	var area1_alterna_azul = [
		//inicia en Calz del Federalismo Norte
		//inicia linea y sentido de la flecha animatePolypoint
		...
		//termina linea y sentido de la flecha animatePolypoint
		//termina en Av Fray Antonio Alcalde
	];
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////  linea de Calz. Federalismo hacia Carr. Saltillo  /////////////////////////
	var area1_alterna_azul2 = [
		//inicia en Calz. Federalismo
		//inicia linea y sentido de la flecha animatePolypoint
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////  linea de Carr. Saltillo hacia Calz. Federalismo  /////////////////////////
	var area1_alterna_roja3 = [
		//inicia en Carr. Saltillo
		//inicia linea y sentido de la flecha animatePolypoint
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///  linea de Calle Volcan Quinceo -> Calle Felipe Rubalcaba -> Calle Salvador Vargas hacia Av Mariano Otero  ///
	var area2_alterna_roja = [
		//inicia en Calle Volcan Quinceo
		//inicia linea y sentido de la flecha animatePolypoint
		...
		//termina linea y sentido de la flecha animatePolypoint
		//termina hacia Av Mariano Otero
	];
...
//////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////  linea de Av San Jacinto -> Av del Parque hacia Av San Jacinto  ////////////////
	var area3_alterna_roja = [
		//inicia en Av San Jacinto desvio hacia Av del parque
		//inicia linea y sentido de la flecha animatePolypoint
...
//////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////  linea de Av San Jacinto hacia calle Gigantes  ////////////////////////
	var area3_alterna_rosa = [
		//inicia en Av San Jacinto
		//inicia linea y sentido de la flecha animatePolypoint
		[20.6549223116231, -103.29964220523836],
		[20.662373729749486, -103.29849153757097],
		//termina hacia calle Gigantes
	];
...
//////////////////////////////////////////////////////////////////////////////////////////////////
//////////////  linea de Av Juan Gil Preciado -> Tercera Ote hacia Av Base Aerea  ////////////////
	var linea1_roja = [
		//inicia en Av Juan Gil Preciado
		//inicia sentido de la linea y la flecha animatePolypoint
		...
		//termina sentido de la linea y la flecha animatePolypoint
		//termina hacia Av Base Aerea
	];
...
//////////////////////////////////////////////////////////////////////////////////////////////////
////////////////  linea de Av Juan Gil Preciado hacia Camino viejo a tesistan  ///////////////////
	var linea3_roja = [
		//inicia en Av Juan Gil Preciado
		//inicia sentido de la linea y la flecha animatePolypoint
		...
		//termina sentido de la linea y la flecha animatePolypoint
		//termina hacia Camino viejo a tesistan
	];
...
//////////////////////////////////////////////////////////////////////////////////////////////////
/////////  linea de Acueducto -> Av Patria -> Acueducto y hacia Anillo Periferico Norte  /////////
	var acu_linea1_roja_1 = [
		//inicia en Av. Patria
		//inicia sentido de la linea y la flecha animatePolypoint
		[20.70823368610495, -103.40577721595766],
		...
		//nuevo
		[20.711821399440147, -103.39778423309328],
		[20.711971931010137, -103.39785397052765],
		[20.712062249880375, -103.39794516563417],
		[20.7113647860964, -103.4002733230591],
		[20.711319626460163, -103.40091168880464],
		//agregado
...
//////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////  linea de Av Patria hacia Av Paseo Royal Country  //////////////////
//////////////////////////////////  inicia sentido animatePolypoint  /////////////////////////////
	/*var acu_linea1_roja_2 = [
		...
		//Termina hacia Av Paseo Royal Country 
	];
	var polyline = L.polyline(acu_linea1_roja_2, {color: 'red',dashArray: '10'}).addTo(obras);*/

	/*var acu_linea1_roja_22 = [ //Flecha animate
		//inicia sentido animatePolypoint
		[20.711352241754355, -103.40065956115724], 
		[20.71130206437577, -103.40113162994386],
		[20.711402419116315, -103.4017324447632],
...
//////////////////////////////////////////////////////////////////////////////////////////////////
///////////////  linea de Av. Patria para acueducto y hacia Anillo Periferico Norte  /////////////
	var  acu_linea2_roja_acueducto = [
	 	//Inicia en Av Patria
		[20.708941199933264, -103.40915143489839],
		[20.70908671655226, -103.40899586677553],
		[20.70937273156864, -103.40835750102997],
		[20.709623621489463, -103.40752601623537],
		[20.70979924418691, -103.40740799903871],
		[20.710040097841052, -103.4073328971863],
		[20.71024080892708, -103.40738654136659],
		[20.71068739013978, -103.40774595737459],
		[20.711123934547622, -103.4080356359482],
...
////////  flecha de Av. Patria para acueducto y hacia Anillo Periferico Norte  /////////
	var  acu_linea2_roja_acueducto = [
		//Flecha animate inicia en Av. Patria
		//inicia sentido animatePolypoint
		[20.708941199933264, -103.40915143489839],
		[20.70908671655226, -103.40899586677553],
		[20.70937273156864, -103.40835750102997],
...
//////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////  linea de acueducto y hacia Pablo Neruda  /////////////////////////
	var acu_linea3_roja =[
		//inicia en Acueducto
		//inicia linea y sentido de flecha animatePolypoint
		...
		[20.71011536452946, -103.407461643219],
		[20.709989920028, -103.40749919414522],
		[20.70973401292304, -103.40741336345674],
		[20.709593514720883, -103.40726852416994],
		[20.709473087586815, -103.40708613395691],
		[20.70945803418832, -103.40692520141603],
		[20.708906075211186, -103.40649604797365],
		[20.708068097285206, -103.40583622455598],
		[20.706537646600463, -103.40462923049928],
		[20.705800014030373, -103.4040552377701]
...
//////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////  linea de Av. Pablo Neruda hacia Av. Patria  ///////////////////////

		var acu_linea4_roja =[
		//inicia en Av. Pablo Neruda
		//inicia linea y sentido de la flecha animatePolypoint	
		[20.69661192254012, -103.39285969734193],
		[20.69619540929785, -103.39462459087373],
		[20.695904351172484, -103.39591205120088],
		[20.695934460659632, -103.3960407972336],
		[20.695894314675424, -103.39619100093843],
		[20.695834095679214, -103.3962768316269],
		[20.695668493316326, -103.39628219604492],
		[20.69519175823182, -103.39827239513399],
		[20.694795314230866, -103.39991927146913],
		[20.694233265263687, -103.40230643749238],
		[20.69399238649732, -103.40285897254945],
		[20.693380151244387, -103.40407133102418],
		[20.69309410605789, -103.40458095073701],
		[20.692562160943446, -103.40509057044984],
		[20.692155673325026, -103.40542316436769],
		[20.691929846399674, -103.4057343006134],
		[20.691854570683173, -103.40605080127717],
		[20.691824460386126, -103.40678572654724],
		[20.6918395155354, -103.40875446796419],
		[20.691769258159333, -103.40923726558687],
		[20.691779294929333, -103.40988099575044],
		[20.691804386851434, -103.410701751709],
		[20.691824460386126, -103.4117639064789],
		[20.691724092686105, -103.41221988201143],
		[20.691658853645485, -103.41279387474061],
		[20.69164881686751, -103.4136039018631],
		[20.691628743309572, -103.41448903083803],
		[20.691663872034226, -103.41485917568208],
		[20.69176423977408, -103.41512739658357],
		[20.69400493227586, -103.41519713401796],
		[20.695392488976374, -103.41523468494417],
		[20.696406175177877, -103.41556727886201],
		[20.697173962692315, -103.41573894023897],
		[20.697700873443228, -103.41585159301758],
		[20.698172582467087, -103.41592133045198],
		[20.69862421739155, -103.41591596603395],
		[20.698985524362634, -103.41586768627168],
		[20.69959271886107, -103.41573894023897],
		[20.70046587032388, -103.4155833721161],
		[20.701584901916153, -103.41529905796051],
		[20.70224226639967, -103.41496109962465],
		[20.703381356885775, -103.4143763780594],
		[20.70505234197992, -103.41351807117464],
		[20.70625162623406, -103.41289579868317],
		//hacia Av. Patria
		[20.70672958101742, -103.41251492500307],
		[20.707108431244755, -103.41213941574098],
		[20.70742957506676, -103.4116217494011],
		[20.708879731664293, -103.4091863036156],
		[20.70907291756853, -103.40896904468538],
		[20.70934137029932, -103.40835750102997],
		[20.70971017841578, -103.40716123580934],
		[20.710066441186243, -103.40670794248582],
		[20.7103248566154, -103.40654969215394],
		[20.710728786646232, -103.4064531326294],
		[20.71122303497082, -103.40636998414995],
		[20.711506537089388, -103.40621173381805],
		[20.711792547538806, -103.40589523315431],
		[20.711945587996183, -103.40544462203981],
		[20.711885375375672, -103.40480357408525],
...
///////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////  Obra Paseos del Sol   //////////////////////////////////////
//  linea de Av. Enrrique Ladron de Guevara  --> Calle Tomas Balcazar hacia Calle Felipe Zetter  //

	var paseos_linea2_roja =[
		//inicia en Av. Enrrique Ladron de Guevara
		//inicia linea y sentido de la flecha animatePolypoint	
		[20.63711673682443, -103.42819511890411],
		[20.636584595657837, -103.4277927875519],
		[20.63564581377856, -103.42928946018219],
		[20.635334558614787, -103.429793715477],
		[20.634707026106682, -103.43070030212404],
		[20.634174876511832, -103.43151569366455],
		[20.634009206918453, -103.43198776245119],
		[20.633964024270764, -103.43281388282777],
		[20.633266201675017, -103.43276560306549]
		//Termina linea en Calle Felipe Zetter
		//termina sentido animatePolypoint	
	];

	var polyline = L.polyline(paseos_linea2_roja, {color: '#9900FF', dashArray: '10'}).addTo(obras);
	animatePolypoint(polyline, '#C80003');
// --------------------------------------------------------------------------------------------------
// --------------------------------------------------------------------------------------------------
